    ...
    scan(entries_matching_path) {
        return new Promise((success) => __awaiter(this, void 0, void 0, function* () {
            ...
            //Fetch directory_path's Dirent
            {
                ...
                const dir_name = this.path.slice(last_separator_idx + 1, end_dir_name_idx);
                let dir_found = false;
                fs_promises.opendir(parent_dir_path).then((parent_directory) => { var parent_directory_1, parent_directory_1_1; return __awaiter(this, void 0, void 0, function* () {
                    var e_1, _a;
                    try {
                        for (parent_directory_1 = __asyncValues(parent_directory); parent_directory_1_1 = yield parent_directory_1.next(), !parent_directory_1_1.done;) {
                            const parent_dir_entry = parent_directory_1_1.value;
                            if (parent_dir_entry.name === dir_name) {
                                dir_found = true;
                                _scan(parent_dir_path, parent_dir_entry, entries_matching_path).then((tree) => {
                                    this.tree = tree;
                                    success(this);
                                });
                            }
                        ...
                        try {
                            if (parent_directory_1_1 && !parent_directory_1_1.done && (_a = parent_directory_1.return)) yield _a.call(parent_directory_1);
                        }
...
function _scan(parent_dir_path, dir_ent, path) {
    return new Promise((success, reject) => {
        ...
        */
        const { bAll_wildcard, entry_to_find_reg, bEntry_to_find_is_dir, bIterate_subdirs, } = get_path_request(path);
        //
