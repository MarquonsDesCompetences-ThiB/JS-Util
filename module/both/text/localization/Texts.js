...
import { json, string } from "../../types/_types.js";
...
export class Texts extends Texts_props {
     ...
     * @return dest_obj
     */
    add_texts_multi(dest_obj, accessors, lang_id) {
     ...
     */
    static get(texts, property_accessor) {
        logger.log = "get_text ";
        //
        // Check preconds
        {
            ...
            // undefined or null
            {
                ...
                if (undef_null) {
                    if (dest_obj[key]) {
                        ...
                        ret.nb_nset++;
                        const msg = "Localized text 'undefined' or 'null' not found for : " + key;
                        logger.error = msg;
                    }
                    continue;
                }
