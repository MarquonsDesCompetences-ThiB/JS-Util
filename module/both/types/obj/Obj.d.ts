...
export declare class Obj extends Obj_props {
    static keys(object: Obj, props_flags?: props_specs.eSpec): string[];
    static values(object: Obj, props_flags?: props_specs.eSpec): any[];
    static entries(object: Obj, props_flags?: props_specs.eSpec): [string, any][];
    /**
     ...
     * @param {*} values
     */
    static get_property_values_errors(class_constructor: any, values: any): {};
    /**
    ...
    clone(props_flags?: props_specs.eSpec, explicit?: boolean): any;
     ...
     *                          to string are null
     */
    toJSON(specs_flags?: number, as_string?: boolean): {};
    ...
    get(props_flags?: props_specs.eSpec, clone?: boolean): any;
    /**
     ...
     */
    set(values: any, props_flags?: props_specs.eSpec, silent_errs?: boolean): {
        nb_set: number;
        nb_already: number;
        nb_nset: number;
        nb_nset_ro: number;
