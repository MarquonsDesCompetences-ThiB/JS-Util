...
export function new_global_logger(path = join_path(process.env.SRC_ROOT ? process.env.SRC_ROOT : "", "logs"), file_name_prefix = "") {
...
export function new_std_err_logger(path = join_path(process.env.SRC_ROOT ? process.env.SRC_ROOT : "", "logs"), file_name_prefix = "") {
    /*process.stderr =*/ new Logger(path, file_name_prefix, process.stderr);
}
export function new_std_out_logger(path = join_path(process.env.SRC_ROOT ? process.env.SRC_ROOT : "", "logs"), file_name_prefix = "") {
