import { iUpdates_Res, Xlsx_File_props } from "./_props/Xlsx_File_props.js";
/**
...
export declare class Xlsx_File extends Xlsx_File_props {
     ...
     *                    Reject: {string} err
     */
    read(bLoad_content?: boolean, sheet_id_or_name?: string | number): Promise<(string | number)[][] | number>;
    /**
     ...
     */
    read_row(row_id: number, sheet_id_or_name?: number | string): any;
    /**
     *
     * @param {integer | string | undefined} sheet_id_or_name
     *                                        For xlsx files
     ...
     *                    Reject: {string} err
     */
    write(sheet_id_or_name?: number | string): Promise<any>;
    /**
     ...
     *                                    xlsx : Nb cells
     */
    apply_updates(): Promise<iUpdates_Res>;
    /**
     * @return {Promise} Cf. this.apply_updates
     */
    release(): Promise<iUpdates_Res>;
}
