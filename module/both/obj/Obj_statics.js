            ...
            // which calls super getter if any
            {
                if (props_c[prop].get) {
                    if (final_props[prop].get) {
                        final_props[prop].get = new_getter(final_props[prop].get, props_c[prop].get);
                        /**
            ...
            // which calls super setter if any
            {
                if (props_c[prop].set) {
                    if (final_props[prop].set) {
                        final_props[prop].set = new_setter(final_props[prop].set, props_c[prop].set);
                        /**
...
export function dynamic_extends(oChildChain, oExtendsProto) {
    ...
    let o2nd, oLast;
    let oNewProto = oExtendsProto, oReturn = (o2nd = oLast =
        oChildChain instanceof Object
            ? oChildChain
            : new oChildChain.constructor(oChildChain));
    for (var o1st = Object.getPrototypeOf(o2nd); o1st !== Object.prototype && o1st !== Function.prototype; o1st = Object.getPrototypeOf(o2nd)) {
        o2nd = o1st;
    }
...
export function get_non_enumerable_keys(obj) {
    const enum_keys = Object.keys(obj);
    const all_symbols = util.inspect(obj, {
        depth: 0,
        showHidden: true,
    });
...
//# sourceMappingURL=Obj_statics.js.map