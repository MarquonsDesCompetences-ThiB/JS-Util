...
export class Obj extends Obj_props {
    ...
    static keys(object, props_flags = props_specs.eSpec.ALL_NOT_JSONIFYING) {
        return props_specs.keys(object, props_flags);
    }
    static values(object, props_flags = props_specs.eSpec.ALL_NOT_JSONIFYING) {
        return props_specs.values(object, props_flags);
    }
    static entries(object, props_flags = props_specs.eSpec.ALL_NOT_JSONIFYING) {
    ...
    clone(props_flags = props_specs.eSpec.ALL_JSONIFYING, explicit) {
     ...
     *                          to string are null
     */
    toJSON(specs_flags = props_specs.eSpec.JSON_PRIVATE, as_string) {
        let ret = {};
    ...
    //
    // === GETTERS / SETTERS ===
    get(props_flags = props_specs.eSpec.ALL_NOT_JSONIFYING, clone) {
     ...
     */
    set(values, props_flags = props_specs.eSpec.ALL, silent_errs) {
        const set_res = {
            nb_set: 0,
            nb_already: 0,
            nb_nset: 0,
